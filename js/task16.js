...
function renderAqiList() {
    ...
    for (var strCity in aqiData) {
        ...
        table.innerHTML += '<tr><td>' + strCity + '</td><td>' + aqiData[strCity] + '</td><td><button class="del-btn">删除</button></td></tr>';
    }
}
...
function delBtnHandle(e) {
    ...
    var strCity=tr.childNodes[0].innerText;
